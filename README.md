This is a simple voice recognition project that allows you to control colored lamps (Red, Green, Blue, Yellow) using voice commands or manual buttons. The interface is built using Python and Tkinter.
